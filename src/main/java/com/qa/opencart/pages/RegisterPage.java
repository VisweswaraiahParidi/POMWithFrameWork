...
public class RegisterPage {
    ...
    public boolean registerUser(String firstName, String lastName, String email, String telephone, String password,
        ...
        eleUtil.waitForVisibilityOfElement(this.firstName, AppConstans.MEDIUM_TIME_OUT).sendKeys(firstName);
        ...
        String successMessg = eleUtil.waitForVisibilityOfElement(this.successMessg, AppConstans.MEDIUM_TIME_OUT).getText();
        System.out.println(successMessg);
        if (successMessg.contains(AppConstans.USER_REGISTER_SUCCESS_MESSG)) {
